...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { biography: @instructor.biography, name: @instructor.name, style: @instructor.style }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { biography: @instructor.biography, name: @instructor.name, style: @instructor.style }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
