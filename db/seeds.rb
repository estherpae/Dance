...
Exercise.destroy_all
  e1 = Exercise.create({:name => "Improve Flexibility - Kicks", :user_id => u1.id, :description => "Make sure you are warm and have stretch clothes on before you start the exercise. First, you start off by going into a lunge with one leg bent in front and the other bent behind.  Next, slide carefully into your splits.  Hold each side for 1 minute (It helps if you put a timer on your phone).  Also make sure you do your middle splits for a minute as well.  Make sure that your legs are in a straight line when you stretch your middle splits (I use the wall as my 'ruler').  Once you have mastered the splits or want to improve more rapidly on your regular splits, try the oversplits.  This is when you have your front or back leg on a chair or any elevated surface and your slide into your splits.  Or in the case of the middle legs, put one leg on the chair/elevated surface and slide into your middles splits.  Hold each side for 1 minute.   This will help you improve your flexibility.  Hope it helps!"})
